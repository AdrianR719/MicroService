...
<html>
    ...
    <body>
        ...
        <div id="show-impuesto" class="content scaffold-show" role="main">
            ...
            <f:display bean="impuesto" />
            <g:form resource="${this.impuesto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.impuesto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
